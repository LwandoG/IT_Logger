...
const AddLogModal = ({ addLog }) => {
    ...
    const onSubmit = () => {
        if(message === '' || tech === '') M.toast({ html: 'Please enter a message and technician'})
        else {
           ...
           <div className="modal-content">
               ...
               <div className="row">
                   <div className="input-field">
                       <p>
                           <label>
                               <input type="checkbox" className="filled-in" checked={attention} value={attention} onChange={e =>
